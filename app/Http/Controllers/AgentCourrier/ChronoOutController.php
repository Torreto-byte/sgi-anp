...
class ChronoOutController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('service-courrier.chrono-depart.chrono', compact('items'));
    }
    ...
    {
        return view('service-courrier.chrono-depart.addForm');
    }
    ...
    public function store(Request $request)
    {
        ...
        if (ChronoOut::where('numero', $request->numero.'-'.date('Y'))->exists()) {
    ...
    public function edit($id)
    {
        ...
        return view('service-courrier.chrono-depart.editForm', compact('singleData'));
    }
