...
@section("title", "Imputation d'un courrier arrivé")
...
@section('content')
                ...
                <div class="page_title_left">
                    ...
                    <ol class="breadcrumb page_bradcam mb-0">
                        <li class="breadcrumb-item">
                            <h6 class="m-0 text-red-600">Imputation du courrier <strong> {{ $singleData->numero }} </strong> </h6>
                        </li>
                    </ol>
                </div>
            </div>
    ...
    <form method="POST" action="{{ route('agentSaveImputation') }}" enctype="multipart/form-data">
        @csrf
                ...
                <div class="white_card">
                    ...
                    <div class="card-body">
                                ...
                                <div class="row mb-4">
                                    ...
                                    <div class="col-lg-9 col-xl-8">
                                        <select name="instruction" class="form-control @error('instruction') is-invalid @enderror" required>
                                            <option>Sélectionnez une instruction</option>
                        ...
                        <div class="d-flex">
                            ...
                            <button type="submit" class="btn_1 mt-1 mb-1 w-40">Imputer</button>
                        </div>
                    </div>
