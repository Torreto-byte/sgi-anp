...
class LettersOutController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('service-courrier.courrier-depart.listing', compact('items'));
    }
    ...
    public function create()
    {
        ...
        return view('service-courrier.courrier-depart.addForm', compact('getDataChrono'));
    }
    ...
    public function show($id)
    {
        ...
        return view('service-courrier.courrier-depart.showForm', compact('item'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('service-courrier.courrier-depart.editForm', compact('singleData', 'getDataChrono'));
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('courrier-depart.index');
    }
