                ...
                <div class="white_card_header">
                    <div class="box_header m-0">
                        <div class="main-title">
                            <h3 class="m-0">Fermeture du chrono</h3>
                        </div>
                    </div>
                </div>
                <div class="white_card_body">
                    <div class="card-body">
                        <form method="POST" action="{{ route('chrono-arrive.update', $singleData->id) }}">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="row mb-3">
                                <div class="col-md-6">
                                    ...
                                    <input type="text" name="numero" value="{{ $singleData->numero }}" class="form-control fs-5" readonly>
                                </div>
                            </div>
                            <div class="row mb-3">
                                <div class="col-md-6">
                                    <label class="form-label" for="inputEmail4">Numéro de fin</label>
                            ...
                            <a href="{{ route('chrono-arrive.index') }}" class="btn btn-info ms-5">Annuler</a>
                        </form>
                    </div>
                </div>
            </div>
